...
typedef unsigned int(_cdecl * pfunc_set_param)(void*, char* key, unsigned int value);
typedef unsigned int(_cdecl * pfunc_get_param)(void*, char* key, unsigned int* value);
...
struct hw_descriptor {
    ...
    pfunc_set_param               _hwproc_set_param;               //6
    pfunc_get_param               _hwproc_get_param;               //7
